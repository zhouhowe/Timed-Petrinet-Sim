...
void lcgrandst (long zset, int stream) /* Set the current zrng for stream to zset. */
{
zrng[stream] = zset;
}
...
double expon(double mean, int stream) /* Exponential variate generation function. */
{
...
float erlang(int m, float mean, int stream)  /* Erlang variate generation function. */
{
    int   i;
